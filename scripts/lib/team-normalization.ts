...
export const teamNormalizations: TeamNormalization[] = [
  ...
  { sourceNamePt: "Playoff Europeu A", code: "UEFA_PLAYOFF_A", nameEn: "UEFA Playoff A", namePt: "Playoff Europeu A", flagCode: null, federation: "UEFA", isPlaceholder: true, placeholderType: "uefa_playoff" },
  { sourceNamePt: "Playoff Europeu B", code: "UEFA_PLAYOFF_B", nameEn: "UEFA Playoff B", namePt: "Playoff Europeu B", flagCode: null, federation: "UEFA", isPlaceholder: true, placeholderType: "uefa_playoff" },
  { sourceNamePt: "Playoff Europeu C", code: "UEFA_PLAYOFF_C", nameEn: "UEFA Playoff C", namePt: "Playoff Europeu C", flagCode: null, federation: "UEFA", isPlaceholder: true, placeholderType: "uefa_playoff" },
  { sourceNamePt: "Playoff Europeu D", code: "UEFA_PLAYOFF_D", nameEn: "UEFA Playoff D", namePt: "Playoff Europeu D", flagCode: null, federation: "UEFA", isPlaceholder: true, placeholderType: "uefa_playoff" },
  { sourceNamePt: "Playoff Intercontinental 1", code: "INTERCONTINENTAL_PLAYOFF_1", nameEn: "Intercontinental Playoff 1", namePt: "Playoff Intercontinental 1", flagCode: null, federation: "INTERCONTINENTAL", isPlaceholder: true, placeholderType: "intercontinental_playoff" },
  { sourceNamePt: "Playoff Intercontinental 2", code: "INTERCONTINENTAL_PLAYOFF_2", nameEn: "Intercontinental Playoff 2", namePt: "Playoff Intercontinental 2", flagCode: null, federation: "INTERCONTINENTAL", isPlaceholder: true, placeholderType: "intercontinental_playoff" },
