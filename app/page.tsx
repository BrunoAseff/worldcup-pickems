export default function Home() {
  return (
    <main className="flex flex-1 items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(138,224,178,0.22),_transparent_38%),linear-gradient(180deg,_#f7fff9_0%,_#effaf2_100%)] px-6 py-16">
